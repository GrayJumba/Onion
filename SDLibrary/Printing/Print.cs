...
namespace SDLibrary.Printing
{
    public class Print
    {
        public static readonly Print A4 = new Print("29.7cm", "42cm", "3.18cm", "2.54cm");
        public static readonly Print A4Narrow = new Print("29.7cm", "42cm", "1.27cm", "1.27cm");
        public static readonly Print A4Moderate = new Print("29.7cm", "42cm", "1.91cm", "2.54cm");

        private Size _Size;
        private Thickness _Margin;

        public Print(string w, string h, string leftright, string topbottom)
